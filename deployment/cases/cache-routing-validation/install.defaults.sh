#!/usr/bin/env bash
# Install-time defaults for the cache-routing-validation case.
#
# This file is sourced by scripts/install.sh when:
#   --deployment-case cache-routing-validation
#
...
# Cache routing validation deployments require python tooling in the image.
