#!/usr/bin/env bash
# Start Master: Registry, Router, and 2 paged cache instances for Qwen3-32B
...
CONTAINER_NAME="${CONTAINER_NAME:-infinilm-svc-master-2paged-qwen3-32b}"

LAUNCH_COMPONENTS="${LAUNCH_COMPONENTS:-all}"

# Two paged cache instances for validation comparison (Qwen3-32B)
BABYSITTER_CONFIGS="${BABYSITTER_CONFIGS:-paged-cache-qwen3-32b.toml paged-cache-qwen3-32b-2.toml}"
...
echo "=========================================="
echo "Starting InfiniLM-SVC (2 Paged Cache Qwen3-32B Validation)"
echo "=========================================="
echo "Registry IP: ${REGISTRY_IP}"
echo "Image: ${IMAGE_NAME}"
echo "Registry Port: ${REGISTRY_PORT}"
echo "Router Port: ${ROUTER_PORT}"
echo "Components: Registry, Router, paged-cache-qwen3-32b (8100, GPUs 0-3), paged-cache-qwen3-32b-2 (8300, GPUs 4-7)"
...
echo "Instance 2 (paged-cache-qwen3-32b-2): port 8300, GPUs 4-7 (tp=4)"
echo ""
