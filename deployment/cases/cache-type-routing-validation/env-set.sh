...
# Add HPCC include paths (hcr, hcdnn, hcblas for gemm operations)
export C_INCLUDE_PATH=${C_INCLUDE_PATH}:${MACA_PATH}/include/hcr
if [ -d "${MACA_PATH}/include/hcdnn" ]; then
    export C_INCLUDE_PATH=${C_INCLUDE_PATH}:${MACA_PATH}/include/hcdnn
fi
if [ -d "${MACA_PATH}/include/hcblas" ]; then
    export C_INCLUDE_PATH=${C_INCLUDE_PATH}:${MACA_PATH}/include/hcblas
fi
