#!/usr/bin/env bash
# Start Master: Registry, Router, and 2 paged cache instances
# Validation group for comparing size-based routing vs round-robin
...
CONTAINER_NAME="${CONTAINER_NAME:-infinilm-svc-master-2paged}"

LAUNCH_COMPONENTS="${LAUNCH_COMPONENTS:-all}"

# Two paged cache instances for validation comparison
BABYSITTER_CONFIGS="${BABYSITTER_CONFIGS:-paged-cache-9g_8b_thinking.toml paged-cache-9g_8b_thinking-2.toml}"
...
echo "=========================================="
echo "Starting InfiniLM-SVC (2 Paged Cache Validation)"
echo "=========================================="
echo "Registry IP: ${REGISTRY_IP}"
echo "Image: ${IMAGE_NAME}"
echo "Registry Port: ${REGISTRY_PORT}"
echo "Router Port: ${ROUTER_PORT}"
echo "Components: Registry, Router, paged-cache-9g_8b_thinking (8100), paged-cache-9g_8b_thinking-2 (8300)"
...
echo ""
echo "Instance 1 (paged-cache-9g_8b_thinking): port 8100 (GPU 0)"
echo "Instance 2 (paged-cache-9g_8b_thinking-2): port 8300 (GPU 3)"
echo ""
